...
SET_BANK1 MACRO 
	...
	ENDM
;------------------------------------------------------------------
RTC_START MACRO ;!!!!!команда старт дл€ часов реального времени
	SET_BANK0
	bsf	SDA			; SDA high
	nop
	SET_BANK1
	...
	ENDM
	;-------------------
RTC_STOP MACRO			;!!!!команда стоп дл€ часов реального времени
	SET_BANK0
	bcf	SDA			; SDA low
	nop
	nop
...
;записываютс€ константы, поэтому перед использование нужно их правильно установить
	RTC_START
	banksel SS
	movlw	b'11010000';0D0h			; slave address + write
	call	write_RTC
